...
public abstract class AbstractTicketValidationFilter extends AbstractCasFilter {
     ...
     */
    public TicketValidator getTicketValidator(final FilterConfig filterConfig) {
     ...
     */
    public HostnameVerifier getHostnameVerifier(final FilterConfig filterConfig) {
    ...
    public void initInternal(final FilterConfig filterConfig) throws ServletException {
     ...
     */
    public boolean preFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        return true;
    }
     ...
     */
    public void onSuccessfulValidation(final HttpServletRequest request, final HttpServletResponse response, final Assertion assertion) {
        // nothing to do here.                                                                                            
    }
     ...
     * @param response the HttpServletResponse.
     */
    public void onFailedValidation(final HttpServletRequest request, final HttpServletResponse response) {
        // nothing to do here.
    }
