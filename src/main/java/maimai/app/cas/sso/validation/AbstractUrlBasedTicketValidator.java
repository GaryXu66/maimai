...
public abstract class AbstractUrlBasedTicketValidator implements TicketValidator {
     ...
     */
    public AbstractUrlBasedTicketValidator(final String casServerUrlPrefix) {
     ...
     */
    public void populateUrlAttributeMap(final Map<String,String> urlParameters) {
        // nothing to do
    }
     ...
     */
    public abstract void setDisableXmlSchemaValidation(boolean disabled);
     ...
     */
    public final String constructValidationUrl(final String ticket, final String serviceUrl) {
...
/*       不使用验签
 * 		urlParameters.put(ApiKeysConstant.REQ_KEY.APPKEY, Constants.SSO_USER);
        
        
        Map<String, String> reqParams=SignCore.buildRequestPara(urlParameters,Constants.SSO_KEY);
        urlParameters.putAll(reqParams);*/
     ...
     *
     */
    public abstract Assertion parseResponseFromServer(final String response) throws TicketValidationException;
