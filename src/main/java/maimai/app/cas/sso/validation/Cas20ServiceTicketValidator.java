...
public class Cas20ServiceTicketValidator extends AbstractCasProtocolUrlBasedTicketValidator {
     ...
     */
    public final void populateUrlAttributeMap(final Map<String,String> urlParameters) {
    ...
    public final Assertion parseResponseFromServer(final String response) throws TicketValidationException {
     ...
     */
    public Map<String,Object> extractCustomAttributes(final String xml) {
